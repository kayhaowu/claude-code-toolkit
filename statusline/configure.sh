...
# ── Widget definitions ───────────────────────────────────────────────────────
ALL_WIDGETS=(model bar ctx tokens cost duration lines alert git project version vim)
...
save_config() {
    mkdir -p "$(dirname "$CONF_FILE")"
    {
        ...
        echo "# Widgets: model bar ctx tokens cost duration lines alert git project version vim"
